...
public class Ex4 {
	public static void main(String[] args) {
		...
		System.out.println("차의 최대 속력 : " + NewCar.getMAX_SPPED() + "km/h");
		
		System.out.print("첫 번째 speeUp(100.0km/h): ");
		...
		System.out.print("두 번째 speeUp(90.0km/h): ");
		...
		System.out.print("두 번째 speeUp(210.0km/h): ");
